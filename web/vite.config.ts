...
/*
 * Versija šeit apzināti netiek iešūta. Reiz tā bija — nolasīta no saknes
 * package.json būvējot — bet katrs commit to paceļ, tāpēc iešūtais skaitlis
 * novecoja līdz nākamajai pārbūvēšanai, un ekrāns "Par lietotni" rādīja 0.12,
 * kad īstenībā jau bija 0.12.1. Tagad to prasa serverim (`/api/health`), kas
 * manifestu nolasa startējot. Blakus ieguvums: `0.12.0` → `0.12` pārveide
 * pastāv tikai vienā vietā, server/src/version.ts.
 */
