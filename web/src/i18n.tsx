...
const lv = {
  ...
  todayShort: 'šodien',
  doneForToday: 'Šodien jau izdarīts',
  availableAt: 'Var pieteikt: {times}',
  ...
  timesPerDay: 'Cik reizes dienā',
  timesPerDayHint: '0 = cik reižu vien grib',
  timeWindows: 'Kad to var pieteikt',
  timeWindowsHint: 'Ārpus šī laika darbs būs aizslēgts',
  anyTimeHint: 'Bez laikiem — var pieteikt jebkurā brīdī',
  addWindow: 'Pievienot laiku',
  fromTime: 'No',
  toTime: 'Līdz',
  windowIncomplete: 'Jāieraksta abi laiki',
  windowBackwards: 'Beigu laikam jābūt pēc sākuma',
  windowOverlap: 'Laiki pārklājas',
  ...
  err_outside_time_window: 'Šo darbu tagad nevar pieteikt — paskaties, kad tas ir atvērts',
  err_daily_limit_reached: 'Šodien šis darbs jau ir izdarīts pietiekami reižu',
  err_invalid_time_window: 'Nederīgi laiki',
  err_too_many_windows: 'Par daudz laika logu',
...
const en: Partial<Dict> = {
  ...
  todayShort: 'today',
  doneForToday: 'Already done today',
  availableAt: 'Can be filed: {times}',
  ...
  timesPerDayHint: '0 = as often as you like',
  timeWindows: 'When it can be filed',
  timeWindowsHint: 'Outside these hours the deed is locked',
  anyTimeHint: 'No hours set — can be filed at any time',
  addWindow: 'Add a time',
  fromTime: 'From',
  toTime: 'To',
  windowIncomplete: 'Both times are needed',
  windowBackwards: 'The end must come after the start',
  windowOverlap: 'These times overlap',
  ...
  err_outside_time_window: 'This deed cannot be filed right now — check when it is open',
  err_daily_limit_reached: 'This deed has already been done enough times today',
  err_invalid_time_window: 'Those times do not work',
  err_too_many_windows: 'Too many time windows',
